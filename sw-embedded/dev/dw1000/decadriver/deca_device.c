...
void dwt_readdiagnostics(dwt_rxdiag_t *diagnostics)
{
    ...
    uint8_t rx_fqual[8];
    dwt_readfromdevice(RX_FQUAL_ID, 0x0, 8, rx_fqual);
    // |63......................48| 47........................32|
    // [CIR_PWR_MSB][CIR_PWR_LSB]  [PP_AMPL3_MSB][PP_AMPL3_LSB]
    // |31......................16| 15.........................0|
    // [FP_AMPL2_MSB][FP_AMPL2_LSB][STD_NOISE_MSB][STD_NOISE_LSB]
    diagnostics->maxGrowthCIR = (((uint16)rx_fqual[7]) << 8) + (((uint16)rx_fqual[6]) & 0x00ff);
    diagnostics->firstPathAmp3 = (((uint16)rx_fqual[5]) << 8) + (((uint16)rx_fqual[4]) & 0x00ff);
    diagnostics->firstPathAmp2 = (((uint16)rx_fqual[3]) << 8) + (((uint16)rx_fqual[2]) & 0x00ff);
    diagnostics->stdNoise = (((uint16)rx_fqual[1]) << 8) + (((uint16)rx_fqual[0]) & 0x00ff);
...
void dwt_isr(void)
{
    ...
    // TXFRB ... actually starting to send frame
